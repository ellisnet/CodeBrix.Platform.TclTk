...
{
    /// <summary>
    /// This class implements the TclTk <c>namespace</c> command, which provides
    /// a limited emulation of the Tcl <c>namespace</c> ensemble (for example
    /// <c>eval</c>, <c>current</c>, <c>which</c>, and <c>tail</c>).  TclTk does
                                ...
                                case "export":
                                    {
                                        if (arguments.Count >= 2)
                                        {
                                            OptionDictionary options = CommandOptions.GetCommandOptions(
                                                CommandOptionType.Namespace1_Export);
                                ...
                                case "import":
                                    {
                                        ...
                                        {
                                            OptionDictionary options = CommandOptions.GetCommandOptions(
                                                CommandOptionType.Namespace1_Import);
                                ...
                                case "which":
                                    {
                                        ...
                                        {
                                            OptionDictionary options = CommandOptions.GetCommandOptions(
                                                CommandOptionType.Namespace1_Which);
