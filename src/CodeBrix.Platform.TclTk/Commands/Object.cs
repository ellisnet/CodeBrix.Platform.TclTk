...
{
    /// <summary>
    /// This class implements the TclTk <c>object</c> command, which creates,
                                        ...
                                        if (arguments.Count >= 2)
                                        {
                                            ...
                                            if (code == ReturnCode.Ok)
                                            {
                                                ...
                                                ObjectOps.ProcessObjectImportOptions(
                                                    ...
                                                    out pattern, out tcltk, out clr, out noCase);
                                                ...
                                                if ((code == ReturnCode.Ok) && tcltk)
                                                    code = ObjectOps.AddNamespaces(ObjectNamespace.TclTk, ref dictionary, ref result);
