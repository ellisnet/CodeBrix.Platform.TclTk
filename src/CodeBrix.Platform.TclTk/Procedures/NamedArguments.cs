...
namespace CodeBrix.Platform.TclTk._Procedures //was previously: Eagle._Procedures;
{
    ...
    /// procedures whose formal arguments are matched by name rather than by
    /// position.  It derives from <see cref="Core" /> and overrides
    /// <see cref="Execute" /> to bind each supplied name/value pair to the
    /// corresponding named argument, apply default values for any omitted
    /// arguments, collect any remaining values into the variadic argument, and
    ...
    public class NamedArguments : Core
    {
        ...
        /// <summary>
        /// Constructs an instance of the named-argument procedure using the
        /// specified procedure metadata.
        /// </summary>
        /// <param name="procedureData">
        /// The data used to create and identify this procedure, such as its
        /// name, named arguments, and body.  This parameter may be null.
        /// </param>
        ...
        /// <summary>
        /// Executes this procedure by binding the supplied name/value argument
        /// pairs to the procedure's named arguments, applying default values
        /// where needed, and evaluating the procedure body within a new call
        /// frame.
        /// </summary>
        ...
        /// zero is the procedure name; the remaining elements are name/value
