...
{
    /// <summary>
    /// This class compares two strings by testing whether one contains the
    /// other as a sub-string.  It is used to implement sub-string list sorting
    /// for the script engine, and it tracks duplicate elements so that
    /// uniqueness may optionally be enforced.
    /// </summary>
    ...
    internal sealed class StringSubStringComparer : IComparer<string>, IEqualityComparer<string>
    {
        ...
        /// <summary>
        /// Non-zero to perform case-insensitive sub-string matching.
        /// </summary>
        private bool noCase;
        ...
        /// contains the left string as a sub-string.
        /// </summary>
        /// <param name="left">
        /// The first string to compare, treated as the sub-string pattern.
        ...
        /// </param>
        /// <returns>
        /// Zero if the input text contains the sub-string; otherwise, a
        /// non-zero value whose exact magnitude is meaningless.
        /// </returns>
        public int Compare(
            string left,
            string right
