...
{
    /// <summary>
    /// This class provides the static, compiled-in catalog of the built-in
    /// commands, functions, and operators that ship with the core library.
    /// For each kind of entity, it maintains a set of parallel arrays (one
    /// element per entity, kept in the same canonical order) that describe the
    /// implementing type, unique identifier, flags, name, group, and other
    /// associated metadata.  The accessor methods expose these arrays to the
    /// rest of the core library so that the standard set of commands,
    /// functions, and operators can be created and registered without relying
    /// on reflection.  This file is generated by a script and must not be
    /// edited by hand.
    /// </summary>
    ...
    internal static class BuiltIns
    {
        #region Private Data
        /// <summary>
        /// This object is used to synchronize access to the static metadata
        /// arrays that describe the built-in commands, functions, and
        /// operators.
        /// </summary>
        ...
        /// <summary>
        /// The array of types that implement the built-in commands, one entry
        /// per command, in their canonical order.  An entry may be null when
        /// the associated command is not available in the current build
        /// configuration.
        /// </summary>
        ...
        /// <summary>
        /// The array of unique identifiers for the built-in commands, parallel
        /// to the array of command types.
        /// </summary>
        private static Guid?[] commandIds = {
            ...
            /* Binary */ new Guid("f3c1e6a8-9d24-4b7a-8c05-d16f47b2e9d0"),
            ...
            /* Dict */ new Guid("dc87a0be-2552-4244-8fcb-70f581ae0b70"),
            ...
            /* Scan */ new Guid("c17cfc38-46ab-4958-9670-29f4b29e5989"),
            ...
            /* Tailcall */ new Guid("5e0b9c47-2f8d-4a61-b3e9-7c54a8d1f2e6"),
            ...
            /* Trace */ new Guid("9c4e7a25-3d81-4f69-b0c7-e582a4d6f1b9"),
        ...
        /// <summary>
        /// The array of flags for the built-in commands, parallel to the array
        /// of command types.
        /// </summary>
        private static CommandFlags[] commandFlags = {
            ...
            /* Binary */ CommandFlags.Core | CommandFlags.Safe | CommandFlags.Standard,
            ...
            /* Dict */ CommandFlags.Core | CommandFlags.Safe | CommandFlags.Standard,
            ...
            /* Nproc */ CommandFlags.Core | CommandFlags.Safe | CommandFlags.NonStandard,
            ...
            /* Scan */ CommandFlags.Core | CommandFlags.Safe | CommandFlags.Standard,
            ...
            /* Tailcall */ CommandFlags.Core | CommandFlags.Safe | CommandFlags.Standard,
            ...
            ,
#endif
            /* Trace */ CommandFlags.Core | CommandFlags.Safe | CommandFlags.Standard,
        ...
        /// <summary>
        /// The array of explicit names for the built-in commands, parallel to
        /// the array of command types.  An entry may be null when the
        /// associated command uses its default (type-derived) name.
        /// </summary>
        ...
        /// <summary>
        /// The array of group names for the built-in commands, parallel to the
        ...
        /// <summary>
        /// The array of types that implement the built-in functions, one entry
        /// per function, in their canonical order.  An entry may be null when
        /// the associated function is not available in the current build
        /// configuration.
        /// </summary>
        ...
        /// <summary>
        /// The array of unique identifiers for the built-in functions, parallel
        /// to the array of function types.
        /// </summary>
        private static Guid?[] functionIds = {
            ...
            /* Entier */ new Guid("eae9daee-f868-4f7b-9d2f-ec241fb3edb3"),
        ...
        /// <summary>
        /// The array of flags for the built-in functions, parallel to the array
        /// of function types.
        /// </summary>
        private static FunctionFlags[] functionFlags = {
            ...
            /* Entier */ FunctionFlags.Core | FunctionFlags.Unsafe | FunctionFlags.Standard,
        ...
        /// <summary>
        /// The array describing the argument arity of the built-in functions,
        /// parallel to the array of function types.
        /// </summary>
        ...
        /// <summary>
        /// The array of explicit names for the built-in functions, parallel to
        /// the array of function types.  An entry may be null when the
        /// associated function uses its default (type-derived) name.
        /// </summary>
        ...
        /// <summary>
        /// The array of group names for the built-in functions, parallel to the
        ...
        /// <summary>
        /// The array of flags describing the operand types accepted by the
        /// built-in functions, parallel to the array of function types.
        /// </summary>
        private static TypeListFlags[] functionTypeListFlags = {
            ...
            /* Entier */ TypeListFlags.NumberTypes,
            ...
            /* Fmod */ TypeListFlags.NumberTypes,
        ...
        /// <summary>
        /// The array of types that implement the built-in operators, one entry
        /// per operator, in their canonical order.
        /// </summary>
        ...
        /// <summary>
        /// The array of unique identifiers for the built-in operators, parallel
        /// to the array of operator types.
        /// </summary>
        ...
        /// <summary>
        /// The array of flags for the built-in operators, parallel to the array
        /// of operator types.
        /// </summary>
        ...
        /// <summary>
        /// The array of lexemes for the built-in operators, parallel to the
        ...
        /// <summary>
        /// The array describing the operand arity of the built-in operators,
        /// parallel to the array of operator types.
        /// </summary>
        ...
        /// <summary>
        /// The array of names for the built-in operators, parallel to the array
        /// of operator types.
        /// </summary>
        ...
        /// <summary>
        /// The array of group names for the built-in operators, parallel to the
        /// array of operator types.
        /// </summary>
        ...
        /// <summary>
        /// The array of flags describing the operand types accepted by the
        /// built-in operators, parallel to the array of operator types.
        /// </summary>
        ...
        //
        /// <summary>
        /// This method retrieves the static metadata describing the built-in
        /// commands provided by the core library.
        /// </summary>
        /// <param name="length">
        /// Upon success, receives the number of built-in commands.
        /// </param>
        /// <param name="types">
        /// Upon success, receives the array of types that implement the
        /// built-in commands.
        /// </param>
        /// <param name="ids">
        /// Upon success, receives the array of unique identifiers for the
        /// built-in commands.
        /// </param>
        /// <param name="flags">
        /// Upon success, receives the array of flags for the built-in commands.
        /// </param>
        /// <param name="names">
        /// Upon success, receives the array of explicit names for the built-in
        /// commands.
        /// </param>
        /// <param name="groups">
        /// Upon success, receives the array of group names for the built-in
        /// commands.
        /// </param>
        /// <returns>
        /// True if the metadata was retrieved successfully; otherwise, false.
        /// </returns>
        ...
        /// <summary>
        /// This method retrieves the static metadata describing the built-in
        /// functions provided by the core library.
        /// </summary>
        /// <param name="length">
        /// Upon success, receives the number of built-in functions.
        /// </param>
        /// <param name="types">
        /// Upon success, receives the array of types that implement the
        /// built-in functions.
        ...
        /// </param>
        /// <param name="flags">
        /// Upon success, receives the array of flags for the built-in
        /// functions.
        /// </param>
        /// <param name="arguments">
        /// Upon success, receives the array describing the argument arity of
        ...
        /// functions.
        /// </param>
        /// <param name="typeListFlags">
        /// Upon success, receives the array of flags describing the operand
        /// types accepted by the built-in functions.
        /// </param>
        /// <returns>
        /// True if the metadata was retrieved successfully; otherwise, false.
        /// </returns>
        ...
        /// <summary>
        /// This method retrieves the static metadata describing the built-in
        /// operators provided by the core library.
        /// </summary>
        /// <param name="length">
        /// Upon success, receives the number of built-in operators.
        /// </param>
        /// <param name="types">
        /// Upon success, receives the array of types that implement the
        /// built-in operators.
        ...
        /// </param>
        /// <param name="lexemes">
        /// Upon success, receives the array of lexemes for the built-in
        /// operators.
        /// </param>
        /// <param name="operands">
        /// Upon success, receives the array describing the operand arity of the
        /// built-in operators.
        /// </param>
        /// <param name="names">
        /// Upon success, receives the array of names for the built-in
        /// operators.
        /// </param>
        /// <param name="groups">
        /// Upon success, receives the array of group names for the built-in
        ...
        /// <param name="typeListFlags">
        /// Upon success, receives the array of flags describing the operand
        /// types accepted by the built-in operators.
        /// </param>
        /// <returns>
        /// True if the metadata was retrieved successfully; otherwise, false.
        /// </returns>
