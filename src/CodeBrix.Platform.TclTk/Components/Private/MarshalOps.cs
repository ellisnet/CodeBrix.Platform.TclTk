...
namespace CodeBrix.Platform.TclTk._Components.Private //was previously: Eagle._Components.Private;
{
    ...
    /// bridge between TclTk script values and the managed type system,
    ...
    internal static class MarshalOps
    {
        ...
        //
        // NOTE: For use by the CodeBrix.Platform.TclTk._Commands._Hash.IsHashAlgorithm method
        //       only.
        //
        /// <summary>
            ...
            )
        {
            ...
            //       compatibility with the TclTk beta series.
            //
            return true;
        }
        ...
        /// as a well-known TclTk core library object type, modifies the object
            ...
            )
        {
            if (value is IInterpreter)
            {
                ...
                //
                // HACK: This object type is (probably) part of the TclTk
