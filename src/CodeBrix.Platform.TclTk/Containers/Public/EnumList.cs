...
{
    /// <summary>
    /// This class represents a list of managed enumeration values.  It extends
    /// the standard generic list with conversion to the TclTk string list
    /// format, including optional pattern matching.
    /// </summary>
#if SERIALIZATION
    [Serializable()]
#endif
