...
using SomeDictionary = CodeBrix.Platform.TclTk._Containers.Public.FastDictionary<
    ...
    CodeBrix.Platform.TclTk._Interfaces.Private.IEngineContext>;
#else
...
namespace CodeBrix.Platform.TclTk._Containers.Private //was previously: Eagle._Containers.Private;
{
    ...
    /// associated engine context.  Interpreter keys are compared using the
    /// <c>_Comparers._Interpreter</c> equality comparer.
    /// </summary>
    [ObjectId("bd183024-d512-42c4-8364-d31f2503d781")]
    internal sealed class InterpreterEngineContextDictionary : SomeDictionary
    {
        /// <summary>
        ...
        /// </param>
        /// <param name="value">
        /// Upon return, receives the engine context that was associated with
