...
{
    /// <summary>
    /// This class implements the TclTk <c>acos</c> expression function, which
    /// returns the arc cosine (inverse cosine), in radians, of its single
    /// numeric argument.  See <c>core_language.md</c> for expression and
    /// function semantics.
    /// </summary>
    [ObjectId("70b7aadd-6f79-4f40-b304-cfa94a9a4db8")]
    [FunctionFlags(FunctionFlags.Safe | FunctionFlags.Standard)]
    [Arguments(Arity.Unary)]
    [TypeListFlags(TypeListFlags.FloatTypes)]
    [ObjectGroup("trigonometric")]
    internal sealed class Acos : Arguments
    {
        #region Public Constructors
        /// <summary>
        /// Constructs an instance of the <c>acos</c> expression function.
        /// </summary>
        ...
        /// <summary>
        /// This method evaluates the <c>acos</c> function.  It validates the
        /// arguments using the base implementation, converts the single
        /// argument to a double, and produces its arc cosine, in radians.
        /// </summary>
        ...
        /// function name; element one is the value whose arc cosine is
        /// computed.  This parameter should not be null.
        /// </param>
        /// <param name="value">
        /// Upon success, this is set to the computed arc cosine.
        /// </param>
        /// <param name="error">
