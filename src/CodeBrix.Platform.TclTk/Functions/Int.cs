...
{
    /// <summary>
    /// This class implements the TclTk <c>int</c> expression function, which
    /// converts its single numeric argument to a 32-bit integer, truncating any
    /// fractional portion.  Conversions that do not fit in a 32-bit integer
    /// produce an error.  See <c>core_language.md</c> for expression and
    /// function semantics.
    /// </summary>
    ...
    internal sealed class Int : Arguments
    {
        ...
        /// <summary>
        /// Constructs an instance of the <c>int</c> expression function.
        /// </summary>
        ...
        /// <summary>
        /// This method evaluates the <c>int</c> function.  It validates the
        /// arguments using the base implementation, obtains the single argument
        /// as a variant, and converts it to a 32-bit integer.  Date/time,
        /// double, decimal, big-integer, wide-integer, integer, and boolean
        /// values are all supported; floating-point and decimal values are
        ...
        /// </param>
        /// <param name="value">
        /// Upon success, this is set to the converted 32-bit integer value.
        /// </param>
        /// <param name="error">
        ...
        /// numeric, is too large to represent as a 32-bit integer, or a math
