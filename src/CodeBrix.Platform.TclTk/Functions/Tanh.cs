...
{
    /// <summary>
    /// This class implements the TclTk <c>tanh</c> expression function, which
    /// returns the hyperbolic tangent of its single numeric argument.  See
    /// <c>core_language.md</c> for expression and function semantics.
    /// </summary>
    [ObjectId("fa1de01c-9cbe-4eae-a23d-f7318995a233")]
    [FunctionFlags(FunctionFlags.Safe | FunctionFlags.Standard)]
    [Arguments(Arity.Unary)]
    [TypeListFlags(TypeListFlags.FloatTypes)]
    [ObjectGroup("trigonometric")]
    internal sealed class Tanh : Arguments
    {
        #region Public Constructors
        /// <summary>
        /// Constructs an instance of the <c>tanh</c> expression function.
        /// </summary>
        ...
        /// <summary>
        /// This method evaluates the <c>tanh</c> function.  It validates the
        /// arguments using the base implementation, converts the single
        /// argument to a double, and produces its hyperbolic tangent.
        /// </summary>
        ...
        /// function name; element one is the value whose hyperbolic tangent is
        /// computed.  This parameter should not be null.
        /// </param>
        /// <param name="value">
        /// Upon success, this is set to the computed hyperbolic tangent.
        /// </param>
        /// <param name="error">
