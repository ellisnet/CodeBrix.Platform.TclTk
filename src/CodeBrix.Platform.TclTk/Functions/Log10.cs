...
{
    /// <summary>
    /// This class implements the TclTk <c>log10</c> expression function, which
    /// returns the base-10 logarithm of its single numeric argument.  See
    ...
    internal sealed class Log10 : Arguments
    {
        ...
        /// <summary>
        /// Constructs an instance of the <c>log10</c> expression function.
        /// </summary>
        ...
        /// <summary>
        /// This method evaluates the <c>log10</c> function.  It validates the
        /// arguments using the base implementation, converts the single
        /// argument to a numeric variant, and produces its base-10 logarithm,
        /// using big-integer arithmetic when the argument is a big integer.
        /// </summary>
        ...
        /// function name; element one is the value whose base-10 logarithm is
        /// computed.  This parameter should not be null.
        /// </param>
        /// <param name="value">
        /// Upon success, this is set to the computed base-10 logarithm.
        /// </param>
        /// <param name="error">
        ...
        /// numeric, or of an unsupported type, or a math exception occurs, with
