...
{
    /// <summary>
    /// This class implements the TclTk <c>isnan</c> expression function, which
    /// returns non-zero when its single numeric argument is a floating-point
    /// "not-a-number" (NaN) value.  See <c>core_language.md</c> for expression
    ...
    internal sealed class Isnan : Arguments
    {
        ...
        /// <summary>
        /// Constructs an instance of the <c>isnan</c> expression function.
        /// </summary>
        ...
        /// function name; element one is the value tested for NaN.  This
        /// parameter should not be null.
        /// </param>
        /// <param name="value">
        /// Upon success, this is set to non-zero when the argument is a NaN
