...
{
    /// <summary>
    /// This class implements the TclTk <c>sin</c> expression function, which
    /// returns the trigonometric sine of its single numeric argument,
    ...
    internal sealed class Sin : Arguments
    {
        #region Public Constructors
        /// <summary>
        /// Constructs an instance of the <c>sin</c> expression function.
        /// </summary>
        ...
        /// <summary>
        /// This method evaluates the <c>sin</c> function.  It validates the
        /// arguments using the base implementation, converts the single
        /// argument to a double, and produces its trigonometric sine.
        /// </summary>
        ...
        /// function name; element one is the angle, in radians, whose sine is
        /// computed.  This parameter should not be null.
        /// </param>
        /// <param name="value">
        /// Upon success, this is set to the computed sine.
        /// </param>
        /// <param name="error">
