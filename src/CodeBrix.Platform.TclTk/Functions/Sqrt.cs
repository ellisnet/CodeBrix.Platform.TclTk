...
{
    /// <summary>
    /// This class implements the TclTk <c>sqrt</c> expression function, which
    /// returns the square root of its single numeric argument.  See
    ...
    internal sealed class Sqrt : Arguments
    {
        ...
        /// <summary>
        /// Constructs an instance of the <c>sqrt</c> expression function.
        /// </summary>
        ...
        /// <summary>
        /// This method evaluates the <c>sqrt</c> function.  It validates the
        /// arguments using the base implementation, converts the single
        /// argument to a double, and produces its square root.
        /// </summary>
        ...
        /// function name; element one is the value whose square root is
        /// computed.  This parameter should not be null.
        /// </param>
        /// <param name="value">
        /// Upon success, this is set to the computed square root.
        /// </param>
        /// <param name="error">
