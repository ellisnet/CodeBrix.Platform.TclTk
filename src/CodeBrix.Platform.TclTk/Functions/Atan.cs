...
{
    /// <summary>
    /// This class implements the TclTk <c>atan</c> expression function, which
    /// returns the arc tangent (inverse tangent), in radians, of its single
    /// numeric argument.  See <c>core_language.md</c> for expression and
    /// function semantics.
    /// </summary>
    [ObjectId("191ea18f-f921-4486-8038-6f41f1795114")]
    [FunctionFlags(FunctionFlags.Safe | FunctionFlags.Standard)]
    [Arguments(Arity.Unary)]
    [TypeListFlags(TypeListFlags.FloatTypes)]
    [ObjectGroup("trigonometric")]
    internal sealed class Atan : Arguments
    {
        #region Public Constructors
        /// <summary>
        /// Constructs an instance of the <c>atan</c> expression function.
        /// </summary>
        ...
        /// <summary>
        /// This method evaluates the <c>atan</c> function.  It validates the
        /// arguments using the base implementation, converts the single
        /// argument to a double, and produces its arc tangent, in radians.
        /// </summary>
        ...
        /// function name; element one is the value whose arc tangent is
        /// computed.  This parameter should not be null.
        /// </param>
        /// <param name="value">
        /// Upon success, this is set to the computed arc tangent.
        /// </param>
        /// <param name="error">
